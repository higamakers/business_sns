...
/**
 * BoardQuestions Controller
 */
class BoardQuestionsController extends AppController {
...
//Controller : BoardQuestions,boardQuestions
//Model : BoardQuestion,boardQuestion

    public function index(){

        $boardQuestions = $this->paginate();

        $this->set("boardQuestions", $boardQuestions);
    ...
    public function add(){
        ...
        if($this->request->isPost()){//POST
            ...
            if($this->BoardQuestion->save($this->request->data)){
    ...
    public function edit($id = null){
        ...
        if($id != null){
            ...
            //GET
            $boardQuestion = $this->BoardQuestion->read(null, $id);
            
            $this->request->data = $boardQuestion;
    ...
    public function view($id = null){
        ...
        if($id != null){
            ...
            $this->set("boardQuestion", $boardQuestion);
    ...
    public function delete(){
        ...
        if($id != null && $this->request->isPost()){
            ...
            if($this->BoardQuestion->exists()){
                
                if($this->BoardQuestion->delete()){
	...
	if(!empty($this->data) || count($this->passedArgs) > 0){
		...
		if(!isset($this->request->data['clear'])){
			...
			$searchword = $this->request->data["BoardQuestion"];
			...
			$this->request->data['BoardQuestion'] = $searchword;
		...
		$boardQuestions = $this->paginate($options);

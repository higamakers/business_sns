...
<?php echo $this->Form->create('BoardAnswer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Board Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BoardAnswer.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('BoardAnswer.id')))); ?></li>

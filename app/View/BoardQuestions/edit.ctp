...
<?php echo $this->Form->create('BoardQuestion'); ?>
	<fieldset>
		<legend><?php echo __('Edit Board Question'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BoardQuestion.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('BoardQuestion.id')))); ?></li>

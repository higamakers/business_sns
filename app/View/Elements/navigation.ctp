		...
		<ul>
            ...
            <li><?php echo $this->Html->link(__('マイページ'), array('controller' => 'Users', 'action' => 'mypage')); ?> </li>
            
            <li><?php echo $this->Html->link(__('メンバー検索'), array('controller' => 'Users', 'action' => 'profile_search')); ?> </li>

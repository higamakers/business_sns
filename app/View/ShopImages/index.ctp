<div class="shopImages index">
	...
	<tr>
		...
		<td>
			<?php echo $shop_list[$shopImage['ShopImage']['shop_id']]; ?>
		</td>
		<td><?php echo $this->Shop->thumb80($shopImage['ShopImage']['shop_img_url']); ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
        ...
        <li><?php echo $this->Html->link(__('Search Shop Image'), array('action' => 'search')); ?></li>
